...
from kvs import __author__, __license__, __version__
...
setup(
  name = 'KVS',
  version = __version__,
  description = 'Python key-value store manager.',
  long_description = PROJECT_README,
  url = 'https://www.github.com/copyrighthero/KVS',
  download_url = 'https://www.github.com/copyrighthero/KVS',
  author = __author__,
  ...
  keywords = 'KVStore Key-value Store Manager',
  py_modules = ("kvs", ),
  ...
  entry_points = {},
  project_urls = {
    'Source': 'https://www.github.com/copyrighthero/KVS'
  }
)
